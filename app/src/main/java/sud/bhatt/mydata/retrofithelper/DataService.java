...
//    Call<LoginUserDetail> initiateLogin(@Body LoginUser user);
    ...
    @FormUrlEncoded
    @POST("createCustInfo")
    Call<UpdateInfo> createCustInfo(@Header("Authorization") String apiKey, @Field("u_name") String userName,
                                    @Field("u_mobile_num") String mobileNo, @Field("u_location") String location,
                                    @Field("u_project_name") String projectName, @Field("u_requirement") String requirement,
                                    @Field("u_budget") String budget, @Field("info_date") String visitDate,
    ...
    Call<UpdateInfo> updateCustomerDetails(@Header("Authorization") String apiKey, @Path("id") Integer id,
                                           @Field("u_name") String userName, @Field("u_mobile_num") String mobileNo,
                                           @Field("u_location") String location,@Field("u_project_name") String projectName,
                                           @Field("u_requirement") String requirement, @Field("u_budget") String budget,
                                           @Field("info_date") String visitDate, @Field("follow_up_date") String followUpDate);
